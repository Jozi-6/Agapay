        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              <p style={{ margin: 0, fontSize: '14px', opacity: 0.9 }}>Enter beneficiary data</p>
            </div>
            ...
            <div style={{
              ...
              <p style={{ margin: 0, fontSize: '14px', opacity: 0.9 }}>Update inventory records</p>
            </div>
            ...
            <div style={{
              ...
              <p style={{ margin: 0, fontSize: '14px', opacity: 0.9 }}>Log agricultural crises</p>
            </div>
          </div>
        </div>
      </div>
